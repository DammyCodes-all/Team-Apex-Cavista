    ...
    <div className="container mx-auto px-6 relative">
      <motion.div {...fade()} className="max-w-3xl mx-auto text-center">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight text-foreground mb-6">
          How KINAI Turns Data Into <span className="text-primary">Prevention</span>
        </h1>
    ...
    <div className="container mx-auto px-6">
      <motion.div {...fade()} className="max-w-2xl mx-auto bg-card border border-border rounded-2xl p-8 text-center">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed">
          For demonstration purposes, KINAI uses a real-time simulation engine. In production, the app integrates with HealthKit and Google Fit APIs.
        </p>
      </motion.div>
    </div>
  </section>
    ...
    <div className="container mx-auto px-6">
      <motion.div {...fade()} className="max-w-2xl mx-auto text-center">
        <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-4">
          Experience KINAI <span className="text-primary">Today</span>
        </h2>
...
const PageFooter = () => (
  <footer className="border-t border-border py-10">
    <div className="container mx-auto px-6">
      ...
      <p className="text-center text-xs text-muted-foreground mt-6">© 2026 KINAI. All rights reserved.</p>
    </div>
  </footer>
);
