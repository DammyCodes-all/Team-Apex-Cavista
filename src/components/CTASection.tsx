  ...
  <section id="download" className="py-32 relative">
    ...
    <div className="container mx-auto px-6 relative z-10">
      <motion.div
        ...
        className="glass glow-teal p-12 md:p-20 text-center max-w-4xl mx-auto rounded-3xl"
      >
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="#" className="px-8 py-4 rounded-full bg-gradient-to-r from-primary to-primary/80 text-primary-foreground font-semibold text-base hover:opacity-90 transition-opacity shadow-lg shadow-primary/20">
